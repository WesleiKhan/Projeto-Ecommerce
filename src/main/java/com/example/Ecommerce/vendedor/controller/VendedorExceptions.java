...
@ControllerAdvice(basePackages = "com.example.Ecommerce.vendedor.controller.VendedorControllers")
public class VendedorExceptions extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<String> internalError(RuntimeException e) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Error: " + "erro interno estamos tentando resolver!");
    }
}
